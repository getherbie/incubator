...
namespace Herbie2\Loader;

use Herbie2\Alias;
use Herbie2\Exception\ResourceNotFoundException;
use Herbie2\Yaml;
...
class PageLoader
{
    ...
    public function load($alias, $addDefFields = true)
    {
        ...
        if ($addDefFields) {
            ...
            $data['date'] = isset($data['date']) ? $data['date'] : \Herbie2\Helper\PathHelper::extractDateFromPath($alias);
