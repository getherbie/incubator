...
<head>
    ...
    <title><?= $page->title ?> / Herbie Flat-File CMS & Blogyx<?php /*{{ pagetitle({delim:' / ', siteTitle:'Herbie Flat-File CMS & Blog', rootTitle: 'Flat-File CMS und Blog - Herbie', reverse:true}) }}*/ ?></title>
    <link rel="alternate" type="application/rss+xml" title="RSS-Feed" href="<?= $baseUrl ?>/feed.rss">
    <link rel="stylesheet" href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans%3A300italic%2C400italic%2C700italic%2C400%2C300%2C700%2C800&#038;ver=3.8.1">
    <link rel="stylesheet" href="<?= $baseUrl ?>/assets/default/css/pure-min.css">
    <link rel="stylesheet" href="<?= $baseUrl ?>/assets/default/css/styles.css">
    <link rel="stylesheet" href="<?= $baseUrl ?>/assets/default/css/colors.css">
    <!--[if lte IE 8]>
        ...
        <div class="inner-container">
            ...
            <div class="pure-g">
                <div class="pure-u-3-5 pure-u-md-1-5">
                    <h1 class="brand-title"><?= $this->link('/', '<span class="e">E</span> Herbie') ?></h1>
                </div>
...
<script src="<?= $baseUrl ?>/assets/default/js/scripts.js"></script>
